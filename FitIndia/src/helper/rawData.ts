...
> = {
  chest: {
    emoji: '💪',
    color: '#EF4444',
    gradient: ['#EF444470', '#EF444408'],
    label: 'Chest Day',
  },
  back: {
    emoji: '🏋️',
    color: '#3B82F6',
    gradient: ['#3B82F670', '#3B82F608'],
    label: 'Back Day',
  },
  legs: {
    emoji: '🦵',
    color: '#10B981',
    gradient: ['#10B98170', '#10B98108'],
    label: 'Leg Day',
  },
  shoulders: {
    emoji: '🎯',
    color: '#F59E0B',
    gradient: ['#F59E0B70', '#F59E0B08'],
    label: 'Shoulder Day',
  },
  arms: {
    emoji: '💪',
    color: '#8B5CF6',
    gradient: ['#8B5CF670', '#8B5CF608'],
    label: 'Arms Day',
  },
  core: {
    color: '#EC4899',
    emoji: '⚡',
    gradient: ['#EC489970', '#EC489908'],
    label: 'Core Day',
  },
  full_body: {
    emoji: '⚡',
    color: '#22C55E',
    gradient: ['#22C55E70', '#22C55E08'],
    label: 'Full Body',
  },
  cardio: {
    emoji: '🏃',
    color: '#F97316',
    gradient: ['#F9731670', '#F9731608'],
    label: 'Cardio Day',
  },
  rest: {
    emoji: '😴',
    color: '#64748B',
    gradient: ['#64748B70', '#64748B08'],
    label: 'Rest Day',
  },
  default: {
    emoji: '🏋️',
